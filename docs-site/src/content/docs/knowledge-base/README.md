...
* Files in `02-learnings/` use SCREAMING\_SNAKE\_CASE for searchability
...
* [KNOWLEDGE\_BASE\_PHILOSOPHY](/knowledge-base/knowledge_base_philosophy) in `.claude/` for the full philosophy
* [ARCHITECTURE\_COMPONENTS](/knowledge-base/03-reference/architecture_components) for the component analysis (start here for architecture decisions)
