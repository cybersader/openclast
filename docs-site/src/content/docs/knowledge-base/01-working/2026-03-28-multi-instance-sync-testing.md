---
title: 2026-03-28-multi-instance-sync-testing
editUrl: false
...
| Sync daemon USER\_ID | `USER_ID` env var                     | Set per container                 |
...
**What makes them "different":** Separate container IPs, USER\_IDs, plugin client IDs, WebSocket connections.
